...
const Navbar = ({ currentSection }) => {
  return (
    <nav className="w-full p-5 md:px-16 bg-[#f0f0f081] backdrop-blur-3xl border-b flex flex-col md:flex-row items-center justify-between gap-5 fixed top-0 z-10">
